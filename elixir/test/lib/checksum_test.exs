defmodule Advent.ChecksumTest do
  use ExUnit.Case, async: true

  alias Advent.Checksum
  ...
  describe "min-max version" do
    ...
    test "given example" do
      assert Checksum.min_max(@example_input) == 18
    end

    test "real input" do
      assert Checksum.min_max(@input) == 32020
    end
  end

  describe "division version" do
    @example_input [
      [5, 9, 2, 8],
      [9, 4, 7, 3],
      [3, 8, 6, 5]]
    ...
    test "given example" do
      assert Checksum.div(@example_input) == 9
    end

    test "real input" do
      assert Checksum.div(@input) == 236
    end
  end
end
